...
def signin_to_linkedin(driver):
    ...
    input_email = 'arpan.roy93@gmail.com'
    input_password = 'ApuMithul@1993'
...
def get_a_person_to_connect(already_connected_list, 
        ...
        while not someone_to_connect and scroll_times:
            ...
            #MY CHANGE
            a = driver.find_elements_by_xpath('//*[@class="org-people-profiles-module__profile-item"]')
            # print(a)
...
def send_invitations(current_company, invitation_count, scroll_times, driver):
    ...
    already_connected_list = [line.strip() for line in open(file, 'r',encoding='utf-8')]
    ...
    while someone_to_connect and invitation_count:
        ...
        try:
            ...
            button= a_link.find_element_by_xpath('.//button')
        ...
        # a_link.find_element_by_xpath('.//button').click()
        a_link.find_element_by_xpath('/html/body/div[4]/div/div/div[3]/button[1]').click()
